		...
		<div id="page-content">
			...
			<div class="container">
				<div class="row mt30">
                  ...
                  $fetch_image = "SELECT * from `add product` ";
                  ...
                  // echo $id;    
                   ...
                   <a href="#">
                   <img src="assets/img/product/'.$row['image'].'" alt="">
                   </a>
                   </div>
                   <div class="product__content text-center">
                   <div class="produc_desc_info">
                   <div class="product_title">
                   <h4><a href="single-menu.php">'.$row['product name'].'</a></h4>
                   </div>
                   <div class="product_price">
                   <p><i class="fa fa-inr"></i>'.$row['price'].'</p>
                   </div>
                   </div>
                   <div class="product__hover">
                   <ul>
                   <li><a href="#"><i class="fa fa-edit"></i></a></li>
                   <li><a class="cart-fore" href="single-menu.php?view='.$id.'"><i class="fa fa-info"></i></a></li>
                   <li><a href="product-details.html"><i class="fa fa-trash-o"></i></a></li>
                   </ul>
                   </div>
                   </div>
                   </div>
                   ...
                   ?>												
					...
					<div class="col-md-3 col-sm-12 col-xs-12 col-md-pull-9">
						<div class="side-panel">
							<form class="default-form" action="http://new.uouapps.com/takeaway/index.html">
...
<!-- Mirrored from new.uouapps.com/takeaway/menu(view-1).html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Aug 2018 04:31:44 GMT -->
</html>
