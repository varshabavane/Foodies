			...
			<div class="container">
				<div class="row mt30">
                  ...
                  // echo $id;    
                   ...
                   <a href="#">
                   <img src="assets/img/product/'.$row['image'].'" alt="" style="height:90px; width:90px;>
                   </a>
                   </div>
                   <div class="product__content text-center">
                   <div class="produc_desc_info">
                   <div class="product_title">
                   <b><a href="single-menu.php"  style="color:green">'.$row['product name'].'</a></b>
                   </div>
                   ...
                   <script>
	function delete(){
		return confirm('are u sure want to delete the data?');
	}
</script>
